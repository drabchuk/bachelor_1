 ...
 */
public class GdpRawDataAdditionFearures implements RawData {
    ...
    public GdpRawDataAdditionFearures(List<AnnualGDPelement> gdpList) {
    ...
    public TrainingData toTrainingData() {
        ...
        return new TrainingData(addOnes(additionalFeatures), yNormalize);
    }
